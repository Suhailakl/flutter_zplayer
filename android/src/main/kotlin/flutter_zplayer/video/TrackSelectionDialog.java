...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public View onCreateView(
    ...
    TextView okButton = dialogView.findViewById(R.id.track_selection_dialog_ok_button);
    TextView cancelButton = dialogView.findViewById(R.id.track_selection_dialog_cancel_button);
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      View rootView =
              inflater.inflate(
                      R.layout.exo_track_selction_view, container, /* attachToRoot= */ false);
